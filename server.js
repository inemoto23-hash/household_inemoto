...
取引タイプ判定ルール（優先順位順に判定し、該当するキーワードがある場合は必ずそのtypeを選択）:
1. "チャージ"という文言がある場合 → 必ず type: "charge"
   例: "楽天Payに10000円チャージ" → charge
2. "振替" または "AからBに" という文言がある場合 → 必ず type: "transfer"
   例: "楽天銀行から三井住友銀行に5000円振替" → transfer
   例: "楽天銀行から三井住友銀行に5000円" → transfer（「から」「に」があればtransfer）
3. "収入"や"給料"や"入金"や"ボーナス"などの文言がある場合 → 必ず type: "income"
...
絶対ルール:
- キーワード「チャージ」→必ずcharge
- キーワード「振替」または「○○から○○に」→必ずtransfer
- キーワード「収入」「給料」「入金」「ボーナス」→必ずincome
