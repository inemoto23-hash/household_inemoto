...
| | 必要数 |
|---|---|
| 月次の粗利 | 35,500円（固定費 5,500円を含む） |
| 平均実収（プレミアム:上位 = 9:1、手数料引後） | 約 622円 |
| **必要な有料契約** | **約 60契約** |
| 無料からの転換率 5% なら | 登録 **約1,200人** |
| 転換率 10% なら | 登録 **約600人** |

**つまり本当の目標は「登録600〜1,200人」。** ここから先はプロダクトの問題ではなく**集客の問題**になる。

### 現実的な見立て

| 水準 | 有料契約 | 到達性 |
|---|---|---|
| サーバー代が出る（月5千円） | 10 | **ほぼ確実。** 身内＋知人で届く |
| **お小遣い（月3万円）** | **60** | **達成可能。ただし1〜3年かかる** |
| 副業として意味がある（月10万円） | 190 | 難しいが不可能ではない |
| 生活費（月25万円） | 470 | 片手間では届かない。事業として専念する領域 |
